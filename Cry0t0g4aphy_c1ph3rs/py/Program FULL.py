...
bacon_alf = ["AAAAAA","AAAAAB","AAAABA","AAAABB","AAABAA","AAABAB","AAABBA","AAABBB","AABAAB","AABABA","AABABB","AABBAA","AABBAB",
             ...
             "АВВВАА","АВВВАВ","АВВВВА","АВВВВВ","ВААААА","ВААААВ","ВАААВА","ВАААВВ"]
def obrabotka(k):
...
def chetnie(alfavit):
    ...
    chet = []
    i = 1
    while i < len(alfavit):  # составление букв с четными символами (B - формат)
...
def nechetnie(alfavit):
    ...
    nechet = []
    i = 0
    while i < len(alfavit):  # составление букв с нечетными символами (A - формат)
...
#=========================================================================================================================#    
    def _encrypt_сeasar(m,k):
        ...
        global RESULT
        #m - открытое сообщение (незашифрованное)
        #k - ключ для шифрования сообщения
    ...
    def _decrypt_сeasar(c,k):
        ...
        global RESULT
        #с - закрытое сообщение (зашифрованное)
        #k - ключ для дешифрования сообщения
...
#=========================================================================================================================#    
    ...
    def _decrypt_zamena(c):
        global RESULT
        #c - закрытое сообщение (зашифрованное)
...
#=========================================================================================================================#
    ...
    def _decrypt_zamena_kodovoe_slovo(c,k):
        ...
        return result
#=========================================================================================================================#
#                                       МЕТОД ПРОСТОЙ ЗАМЕНЫ (ШИФР БЭКОНА)                                                #
#=========================================================================================================================#
    ...
    def _1_bacon_decrypt(c):
        ...
        return result
#=========================================================================================================================#
#                                   МЕТОД ЗАМЕНЫ ЧЕРЕЗ РЕГИСТР БУКВ (ШИФР БЭКОНА)                                         #
#=========================================================================================================================#
    ...
    def _2_bacon_decrypt(c):
        ...
        return result
#=========================================================================================================================#
#                               МЕТОД ЗАМЕНЫ ЧЕРЕЗ ГЛАСНЫЕ И СОГЛАСНЫЕ (ШИФР БЭКОНА)                                      #
#=========================================================================================================================#
    ...
    def _3_bacon_decrypt(c, glas = "аеиоуыэюя", soglas = "бвгджзйклмнпрстфхцчшщъь"):
        ...
        return result
#=========================================================================================================================#
#                      МЕТОД ЗАМЕНЫ ЧЕРЕЗ ПРИНАДЛЕЖНОСТЬ К ЧАСТЯМ АЛФАВИТА (ШИФР БЭКОНА)                                 #
#=========================================================================================================================#
    def _4_bacon_encrypt(m):
        ...
        for i in range(len(m)):
            if m[i] == "А":
                #result += choice(alf_bacon[:len(alf_bacon[64:]) // 2])
                result += choice(alf_bacon[64:82])#(len(alf_bacon[64:]) // 2)])
            elif m[i] == "В":
                #result += choice(alf_bacon[len(alf_bacon[64:]) // 2:])
                result += choice(alf_bacon[82:])#64+(len(alf_bacon[64:]) // 2):])
            elif m[i] == "A":
                result += choice(alf_bacon[:32])#[:len(alf_bacon[:-36]) // 2])
            elif m[i] == "B":
                result += choice(alf_bacon[32:64])#[len(alf_bacon[:-36]) // 2:])
        RESULT = result
        return result
...
##            elif m[i] == "В":
##                result += choice(alf_bacon[len(alf_bacon[64:]) // 2:])
            if c[i] in alf_bacon[64:82]:#alf_bacon[64:(len(alf_bacon[64:]) // 2)]:#alf_bacon[:len(alf_bacon[64:]) // 2]:
                result += "А"
            elif c[i] in alf_bacon[82:]: #alf_bacon[64+(len(alf_bacon[64:]) // 2):]: #alf_bacon[len(alf_bacon[64:]) // 2:]:
                result += "В"
            elif c[i] in alf_bacon[:32]:#alf_bacon[:len(alf_bacon[:-36]) // 2]:
                result += "A"
            elif c[i] in alf_bacon[32:64]:#alf_bacon[len(alf_bacon[:-36]) // 2:]:
                result += "B"
        result = A1._1_bacon_decrypt(result)
        RESULT = result
        return result
#=========================================================================================================================#
#                     МЕТОД ЗАМЕНЫ ЧЕРЕЗ ПОРЯДКОВЫЙ НОМЕР БУКВЫ (ЧЕТНЫЙ/НЕЧЕТНЫЙ) (ШИФР БЭКОНА)                           #
#=========================================================================================================================#
    ...
    if MENU == "1":
        ...
        if N == "1":
            ...
            if R == "1":
                ...
                input("Нажмите Enter для продолжения...")
                A(MENU)
            #m = input("ВВЕДИТЕ ВАШЕ ЗАКРЫТОЕ СООБЩЕНИЕ: ")
            print()
            print("ВАШ ТЕКСТ: ",A1._encrypt_decrypt_atbash(m))
            print()
            input("Нажмите Enter для продолжения...")
...
#=========================================================================================================================#    
    def _encrypt_skitala(m,k):
        ...
        #m - открытое/закрытое сообщение (незашифрованное/незашифрованное)
        m = normalise(m,alfavit)
        rey = "" ##это псевдоключ, необходиммый для матрицы
        matrix1(m,k)
        result = ""
        for n in range(k):
    ...
    def _decrypt_skitala(c,k):
        global RESULT
        #c - открытое/закрытое сообщение (незашифрованное/незашифрованное)
        matrix2(c,k)
        result = ""
        ...
        return result
#=========================================================================================================================#
#                                        ПРОСТОЙ СТОЛБЦОВЫЙ ПЕРЕСТАНОВОЧНЫЙ ШИФР                                          #
#=========================================================================================================================#  
    ...
    def _decrypt_perestanovka(c,k):
        ...
        return result
#=========================================================================================================================#
#                             ПРОСТОЙ СТОЛБЦОВЫЙ ПЕРЕСТАНОВОЧНЫЙ ШИФР С КЛЮЧОМ / С КОДОВЫМ СЛОВОМ                         #
#=========================================================================================================================# 
...
class C1:
#=========================================================================================================================#
#               1 МЕТОД КВАДРАТА ПОЛИБИЯ (Метод сдвига по столбцам)                                                       #
#=========================================================================================================================#  
    ...
    def _1_decrypt_method_kvadrat_polobia(c,k):
        ...
        return result
#=========================================================================================================================#
#               1 МЕТОД КВАДРАТА ПОЛИБИЯ (Метод сдвига по столбцам) - С КЛЮЧОМ                                            #
#=========================================================================================================================#  
    ...
    def _1_decrypt_method_kvadrat_polobia_kluch(c,k):
        ...
        return result
#=========================================================================================================================#
#               2 МЕТОД КВАДРАТА ПОЛИБИЯ (Метод замены столбцов и строк)                                                  #
#=========================================================================================================================# 
    ...
    def _2_decrypt_method_kvadrat_polobia(c,k):
        ...
        return result
#=========================================================================================================================#
#               2 МЕТОД КВАДРАТА ПОЛИБИЯ (Метод замены столбцов и строк) - С КЛЮЧОМ                                       #
#=========================================================================================================================# 
    ...
    def _2_decrypt_method_kvadrat_polobia_kluch(c,k):
        ...
        return result
#=========================================================================================================================#
#               3 МЕТОД КВАДРАТА ПОЛИБИЯ (Методы циклического сдвига) - С КЛЮЧОМ                                          #
#=========================================================================================================================#
